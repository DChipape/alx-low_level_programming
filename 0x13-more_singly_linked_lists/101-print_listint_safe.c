...
/**
 * count_nodes_till_loop - count nodes to know number of unique nodes to print
 * @head: pointer to linked list head
 *
 * Return: number of unique nodes before loop in a list
 */
...
/**
 * loop - find loop in a linked list
 * @head: pointer to linked list head
 * Return: 0 if no loop, 1 if a loop
 */
